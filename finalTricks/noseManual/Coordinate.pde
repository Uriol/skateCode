...
//    }
    ...
    if (cJumping == false && cGrinding == false) { 
    ...
    if (cJumping == true || cManual == true || cGrinding == true) { // -----------------------------------------------------------------
      ...
      if (c180 == false ) {
        topLeftStroke.setStroke(color(184, 228, 20));
      } 
      else if (c180 == true) {
        topLeftStroke.setStroke(color(0, 200, 255));
      }
      shape(topLeftStroke);
      ...
      if (c180 == false ) {
        bottomRightStroke.setStroke(color(0, 200, 255));
      } 
      else if (c180 == true) {
      ...
      if (c180 == false ) {
        ...
        bottomLeftStroke.setStroke(color(0, 200, 255));
      }
      ...
      if (c180 == false ) {
        ...
        rightEdgeCenter.setFill(color(0, 200, 255));
        rightEdgeNose.setFill(color(0, 200, 255));
        rightEdgeTail.setFill(color(0, 200, 255));
      ...
      if ( c180 == false) {
        ...
        leftEdgeCenter.setFill(color(0, 200, 255));
        leftEdgeNose.setFill(color(0, 200, 255));
        leftEdgeTail.setFill(color(0, 200, 255));
      }
      shape(leftEdgeCenter);
      shape(leftEdgeNose);
      shape(leftEdgeTail);
      ...
      if (c180 == false ) {
        nose_topLeftStroke.setStroke(color(184, 228, 20));
      } 
      else if (c180 == true) {
        nose_topLeftStroke.setStroke(color(0, 200, 255));
      }
      ...
      if (c180 == false ) {
        nose_bottomRightStroke.setStroke(color(0, 200, 255));
      } 
      else if (c180 == true) {
      ...
      if (c180 == false ) {
        ...
        nose_bottomLeftStroke.setStroke(color(0, 200, 255));
      }
      ...
      if (c180 == false ) {
        ...
        nose_rightEdgeCenter.setFill(color(0, 200, 255));
        nose_rightEdgeNose.setFill(color(0, 200, 255));
        nose_rightEdgeTail.setFill(color(0, 200, 255));
        //    rightEdgeCenter.setFill(color(120+cAcceleratingColor*-1,120+cAcceleratingColor*-1, 45));
        //    rightEdgeNose.setFill(color(120+cAcceleratingColor*-1,120+cAcceleratingColor*-1, 45));
        //    rightEdgeTail.setFill(color(120+cAcceleratingColor*-1,120+cAcceleratingColor*-1, 45));
      } 
      ...
      if ( c180 == false) {
        ...
        nose_leftEdgeCenter.setFill(color(0, 200, 255));
        nose_leftEdgeNose.setFill(color(0, 200, 255));
        nose_leftEdgeTail.setFill(color(0, 200, 255));
      }
