...
String csvFile = "8_noseManual_FINAL.csv";
...
float firstJumpSpeed = 0; // for ollie180
...
void calculateLanding(){
  ...
  println("calculateLanding");
    ...
    if (firstJump == true && firstJumpLanding == false) { firstJumpLanding = true;println("firstJump" + firstJump); manual = true; println("manual: " + manual);};
    if (secondJump == true && secondJumpLanding == false) { secondJumpLanding = true; println("secondJump" + secondJump); manual = false; println("manual: " + manual); };
